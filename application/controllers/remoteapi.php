	...
	function employeeRegister()
	{
		...
		if($CONNECTION!=='')
		{
			...
			if(isset($count) && $count > 0 )
			{
				...
				$query= "INSERT INTO newregistration (name,number,password,imei,androideapp,status,created_by,created_on,updated_by,updated_on) VALUES('".$data->employeeName."','".$data->employeeMobileNumber."','".$data->employeePassword."','".$data->employeeIMEI."','androide','recently','".$data->employeeName."','".date('d-m-Y')."','','')"; //echo $query; die;
