		...
		<div class="sidebar-menu toggle-others fixed">
			...
			<?php if(isset($_GET['menu'])!=1){  ?>		
				<ul id="main-menu" class="main-menu hr">
					...
					<!-- class "auto-inherit-active-class" will automatically add "active" class for parent elements who are marked already with class "active" -->
					<li>
						<a href="<?php echo base_url(); ?>admin_panel/admin_dashboard">
					...
					<li>
						<a href="<?php echo base_url(); ?>admin_panel/manage_admin">
					 ...
					 <li>
						<a href="<?php echo base_url(); ?>admin_panel/report">
					...
					<li>
						<a href="<?php echo base_url(); ?>admin_panel/manage_application">
